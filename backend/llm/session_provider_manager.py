...
from .provider_manager import ProviderManager, BaseProvider, LLMResponse
...
class SessionProviderManager:
    ...
    def create_user_manager(self, session_id: str) -> ProviderManager:
        ...
        from .gigachat import GigaChatClient as GigaChatProvider
        from .provider_manager import GeminiProvider, OpenRouterProvider
    ...
    async def test_user_provider(self, session_id: str, provider_name: str) -> Dict[str, Any]:
        ...
        user_manager = self.create_user_manager(session_id)
        return await user_manager.test_provider(provider_name)
