...
TEST_CASES = [
    {
        ...
        "expected_modules": ["intent_router", "llm_service", "emotion"],
        "expected_intent": "conversation",
    },
    {
        "name": "Простой вопрос",
        "message": "Что такое Python?",
        "expected_modules": ["intent_router", "rag", "llm_service", "knowledge"],
        "expected_intent": "question",
    },
    {
        "name": "Сложный вопрос",
        "message": "Объясни подробно как работает машинное обучение и чем оно отличается от традиционного программирования",
        "expected_modules": ["intent_router", "rag", "llm_service", "knowledge", "truth_loop"],
        "expected_intent": "question",
    },
    {
...
async def run_test():
    ...
    for i, test_case in enumerate(TEST_CASES, 1):
        ...
        try:
            ...
            if result.confidence > 0:
                active_modules.add("llm_service")
    ...
    expected_all = {"intent_router", "llm_service", "rag", "knowledge", "emotion", "truth_loop"}
