...
class TestPreIntegration:
    ...
    async def test_encryptor_can_decrypt(self):
        ...
        original = "sk-or-v1-REPLACEDtest-api-key"
...
class TestSecurity:
    ...
    def test_api_key_pattern(self):
        ...
        # sk-or-v1-REPLACED... для OpenRouter
        # AIza... для Google
        
        openrouter_pattern = "sk-or-v1-REPLACED"
        google_pattern = "AIza"
        
        assert openrouter_pattern in "sk-or-v1-REPLACEDabc123"
